...
?>
			...
			<img src="<?php echo esc_url(get_bloginfo('template_directory')); ?>/assets/images/luge_logo.svg" alt="colours of food security logo" class="logo"/>
			...
			<img src="<?php echo esc_url(get_bloginfo('template_directory')); ?>/assets/images/ires_logo.jpg" alt="ires logo" class="logos"/>
							...
							<p>All copyrights reserved to</p> <p class="redtext"> LUGE - 2018</p>
							<div class="red">
							<p>Designed by</p> <p class="redtext">RED Academy Students</p><img src="<?php echo esc_url(get_bloginfo('template_directory')); ?>/assets/images/red_logo.png" alt="red logo" class="red"/>
							</div>
					</div>
