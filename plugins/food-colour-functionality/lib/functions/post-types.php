...
function event_custom_post_type() {
	...
	$labels = array(
		...
		'menu_name'             => __( 'Post Types', 'food-colour' ),
		'name_admin_bar'        => __( 'Post Type', 'food-colour' ),
		'archives'              => __( 'Item Archives', 'food-colour' ),
		'attributes'            => __( 'Item Attributes', 'food-colour' ),
		'parent_item_colon'     => __( 'Parent Item:', 'food-colour' ),
		'all_items'             => __( 'All Items', 'food-colour' ),
		'add_new_item'          => __( 'Add New Item', 'food-colour' ),
		'add_new'               => __( 'Add New', 'food-colour' ),
		'new_item'              => __( 'New Item', 'food-colour' ),
		'edit_item'             => __( 'Edit Item', 'food-colour' ),
		'update_item'           => __( 'Update Item', 'food-colour' ),
		'view_item'             => __( 'View Item', 'food-colour' ),
		'view_items'            => __( 'View Items', 'food-colour' ),
		'search_items'          => __( 'Search Item', 'food-colour' ),
		'not_found'             => __( 'Not found', 'food-colour' ),
		'not_found_in_trash'    => __( 'Not found in Trash', 'food-colour' ),
		'featured_image'        => __( 'Featured Image', 'food-colour' ),
		'set_featured_image'    => __( 'Set featured image', 'food-colour' ),
		...
		'items_list'            => __( 'Items list', 'food-colour' ),
		'items_list_navigation' => __( 'Items list navigation', 'food-colour' ),
		'filter_items_list'     => __( 'Filter items list', 'food-colour' ),
	);
	$args = array(
		'label'                 => __( 'Event', 'food-colour' ),
		'description'           => __( 'Post Type Description', 'food-colour' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor' ),
